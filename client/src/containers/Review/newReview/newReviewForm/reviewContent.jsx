...
const ReviewContent = () => {
    ...
    const postHandle = () => {
        if (checkData()) {
            ...
            ReviewApi.create(reviewObj).then(res => {
                if (res.status == 200) {
                    setLoading(false)
    ...
    return (
        <Stack sx={{ marginLeft: 10, width: '65%' }}>
            ...
            <CustomTextField
                ...
                label="Description" variant="standard" multiline
            ...
            <CustomTextField
                ...
                minRows={3}
                inputProps={{ sx: { color: '#fff' } }}
                label="Plot" variant="standard" multiline
            ...
            <CustomTextField
                ...
                minRows={3}
                inputProps={{ sx: { color: '#fff' } }}
                label="Advantage" variant="standard" multiline
            ...
            <CustomTextField
                ...
                minRows={3}
                inputProps={{ sx: { color: '#fff' } }}
                label="Defect" variant="standard" multiline
            ...
            <CustomTextField
                ...
                minRows={3}
                inputProps={{ sx: { color: '#fff' } }}
                label="Overview" variant="standard" multiline
